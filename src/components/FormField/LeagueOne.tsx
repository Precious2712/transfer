...
export function LeagueOne() {
    const { france, selectedClub } = useAppContext();
    ...
    const selectedClubData = france?.leagueName?.find(club => club.club === selectedClub);
            ...
            <div className="bg-slate-800 p-8 rounded-lg shadow-lg">
                ...
                <div className="bg-red-900/20 border border-red-500 p-6 rounded">
                    ...
                    <p className="text-slate-400 mt-2">
                        Available clubs: {france?.leagueName?.map(club => club.club).join(", ")}
                    </p>
                </div>
            </div>
        );
